...
New-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\AmazonSSMAgent" -Name Environment -Value @("http_proxy=","no_proxy=169.254.169.254", "https_proxy=") -PropertyType
 MultiString -Force;
